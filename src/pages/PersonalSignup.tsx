      ...
      <div className="flex items-center justify-center">
        <div className="w-96 max-w-md">
          ...
          <div className="text-center mb-6">
            <p className="text-2xl font-bold text-black mb-6">개인 회원가입</p>
          </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="w-24 h-12 px-3 py-2 text-sm bg-orange-500 text-white rounded-lg hover:bg-[#E67E22] transition-colors font-medium whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                  ...
                  <div>
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="w-24 h-12 px-3 py-2 text-sm text-[#FF9555] border border-[#FF9555] rounded-lg hover:bg-orange-50 transition-colors font-medium whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed"
                      >
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <label className="flex items-center">
                    ...
                    />
                    <span className="text-gray-700 text-sm">남성</span>
                  </label>
                  <label className="flex items-center">
                    <input
                      type="radio"
                      ...
                      className="mr-2 text-[#FF9555] focus:ring-[#FF9555]"
                    />
                    <span className="text-gray-700 text-sm">여성</span>
                  </label>
                </div>
                {errors.gender && (
                  <p className="mt-1 text-sm text-red-500">
